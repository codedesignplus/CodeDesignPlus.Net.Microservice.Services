...
using CodeDesignPlus.Net.Microservice.Services.gRpc.Services;
...
builder.Services.AddServiceBus<CodeDesignPlus.Net.Microservice.Services.Domain.Startup>(builder.Configuration);
