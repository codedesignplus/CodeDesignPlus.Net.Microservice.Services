...
public class RemoveControllerCommandHandlerTest
{
    ...
    public RemoveControllerCommandHandlerTest()
    {
        ...
        handler = new RemoveControllerCommandHandler(repositoryMock.Object, userContextMock.Object, pubSubMock.Object, Mock.Of<CodeDesignPlus.Net.Cache.Abstractions.ICacheManager>());
    }
