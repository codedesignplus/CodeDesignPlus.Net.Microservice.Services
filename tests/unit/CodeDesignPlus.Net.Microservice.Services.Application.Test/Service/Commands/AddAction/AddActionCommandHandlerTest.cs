...
public class AddActionCommandHandlerTest
{
    ...
    public AddActionCommandHandlerTest()
    {
        ...
        handler = new AddActionCommandHandler(repositoryMock.Object, userContextMock.Object, pubSubMock.Object, Mock.Of<CodeDesignPlus.Net.Cache.Abstractions.ICacheManager>());
    }
